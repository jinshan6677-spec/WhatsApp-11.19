...
快捷回复功能让您可以预先创建常用的回复内容，一键发送，大幅提升工作效率：

**核心功能**：
- 📝 **多种模板类型**：支持文本、图片、音频、视频、图文混合、名片
- 📁 **分组管理**：创建分组和子分组，层级结构组织模板
- 🔍 **快速搜索**：通过关键词快速定位模板
- 🌐 **翻译集成**：支持原文发送或翻译后发送
...
**详细文档**：
- 📖 [快捷回复用户指南](src/quick-reply/USER_GUIDE.md) - 完整使用说明
- 📖 [快捷回复集成指南](src/quick-reply/INTEGRATION_GUIDE.md) - 技术集成说明
- 📖 [快捷回复 API 文档](src/quick-reply/API_DOCUMENTATION.md) - API 接口文档
